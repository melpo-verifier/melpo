...
function normalizeQuestions(questions) {
  ...
  return questions.map((question) => {
    ...
    normalizedQuestion.content = typeof normalizedQuestion.content === "string" ? normalizedQuestion.content : String(normalizedQuestion.content ?? "");
    normalizedQuestion.mcq = normalizeMcqOptions(normalizedQuestion.mcq);
    normalizedQuestion.regexBranches = Array.isArray(normalizedQuestion.regexBranches) ? normalizedQuestion.regexBranches : [];
