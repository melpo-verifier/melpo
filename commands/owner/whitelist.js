...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.addBooleanOption((option) =>
			option.setName("whitelistartleaderboard").setDescription("Whitelist art leaderboard?"),
		),
	async execute({ interaction }) {
		...
		const whitelistArtLeaderboard = interaction.options.getBoolean("whitelistartleaderboard");
