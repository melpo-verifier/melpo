...
module.exports = {
	data: new SlashCommandBuilder()
		.setName("whatsnew")
		.setDescription("All the things changed in Melpo V3 along with a setup guide!")
		.setContexts(0),
	async execute({ interaction }) {
		const linkbuttons = new ActionRowBuilder().addComponents(
			new ButtonBuilder().setStyle("Link").setLabel("Support Server").setURL("https://discord.gg/jjGAwwwxZz"),
			new ButtonBuilder().setStyle("Link").setLabel("Ko-Fi").setURL("https://ko-fi.com/melpo"),
			new ButtonBuilder()
				.setStyle("Link")
